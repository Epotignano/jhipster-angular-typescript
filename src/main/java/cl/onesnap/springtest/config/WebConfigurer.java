...
import cl.onesnap.springtest.web.filter.CachingHttpHeadersFilter;
import cl.onesnap.springtest.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    @Inject
    private SpringTestProperties props;
